...
from openapi_client.models.attributes_embedded_items_inner_all_of import AttributesEmbeddedItemsInnerAllOf  # noqa: E501
from openapi_client.rest import ApiException

class TestAttributesEmbeddedItemsInnerAllOf(unittest.TestCase):
    """AttributesEmbeddedItemsInnerAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AttributesEmbeddedItemsInnerAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributesEmbeddedItemsInnerAllOf`
        """
        model = openapi_client.models.attributes_embedded_items_inner_all_of.AttributesEmbeddedItemsInnerAllOf()  # noqa: E501
        if include_optional :
            return AttributesEmbeddedItemsInnerAllOf(
                code = '', 
    ...
    def testAttributesEmbeddedItemsInnerAllOf(self):
        """Test AttributesEmbeddedItemsInnerAllOf"""
