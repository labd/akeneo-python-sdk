...
from openapi_client.models.product_model_list_all_of import ProductModelListAllOf  # noqa: E501
from openapi_client.rest import ApiException

class TestProductModelListAllOf(unittest.TestCase):
    """ProductModelListAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ProductModelListAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductModelListAllOf`
        """
        model = openapi_client.models.product_model_list_all_of.ProductModelListAllOf()  # noqa: E501
        if include_optional :
            return ProductModelListAllOf(
                code = '', 
                family = '', 
                family_variant = '', 
                parent = '', 
    ...
    def testProductModelListAllOf(self):
        """Test ProductModelListAllOf"""
