...
**labels** | [**PostAttributesRequestLabels**](PostAttributesRequestLabels.md) |  | [optional] 
**group** | **str** | Attribute group | 
**group_labels** | [**PostAttributesRequestGroupLabels**](PostAttributesRequestGroupLabels.md) |  | [optional] 
...
**table_configuration** | [**List[PostAttributesRequestTableConfigurationInner]**](PostAttributesRequestTableConfigurationInner.md) | Configuration of the Table attribute (columns) | [optional] 

## Example

```python
from akeneo.models.post_attributes_request import PostAttributesRequest
...
post_attributes_request_form_dict = post_attributes_request.from_dict(post_attributes_request_dict)
```
