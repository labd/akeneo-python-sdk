...
attributes_embedded_items_inner_instance = AttributesEmbeddedItemsInner.from_json(json)
# print the JSON string representation of the object
print AttributesEmbeddedItemsInner.to_json()

# convert the object into a dict
attributes_embedded_items_inner_dict = attributes_embedded_items_inner_instance.to_dict()
# create an instance of AttributesEmbeddedItemsInner from a dict
attributes_embedded_items_inner_form_dict = attributes_embedded_items_inner.from_dict(attributes_embedded_items_inner_dict)
```
