...
with akeneo.ApiClient(configuration) as api_client:
    ...
    api_instance = akeneo.AttributeGroupApi(api_client)
...
with akeneo.ApiClient(configuration) as api_client:
    ...
    api_instance = akeneo.AttributeGroupApi(api_client)
    code = 'code_example' # str | Code of the resource
    body = akeneo.AttributeGroupsEmbeddedItemsInnerAllOf() # AttributeGroupsEmbeddedItemsInnerAllOf | 
...
with akeneo.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = akeneo.AttributeGroupApi(api_client)
    body = akeneo.AttributeGroupsEmbeddedItemsInnerAllOf() # AttributeGroupsEmbeddedItemsInnerAllOf |  (optional)
...
with akeneo.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = akeneo.AttributeGroupApi(api_client)
    body = akeneo.SeveralAttributeGroupsPatchRequest() # SeveralAttributeGroupsPatchRequest |  (optional)
