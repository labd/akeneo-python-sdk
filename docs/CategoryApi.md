...
with akeneo.ApiClient(configuration) as api_client:
    ...
    api_instance = akeneo.CategoryApi(api_client)
...
with akeneo.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = akeneo.CategoryApi(api_client)
    body = akeneo.PatchCategoriesRequest() # PatchCategoriesRequest |  (optional)
...
with akeneo.ApiClient(configuration) as api_client:
    ...
    api_instance = akeneo.CategoryApi(api_client)
    code = 'code_example' # str | Code of the resource
    body = akeneo.CategoriesEmbeddedItemsInnerAllOf() # CategoriesEmbeddedItemsInnerAllOf | 
...
with akeneo.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = akeneo.CategoryApi(api_client)
    body = akeneo.CategoriesEmbeddedItemsInnerAllOf() # CategoriesEmbeddedItemsInnerAllOf |  (optional)
