...
with akeneo.ApiClient(configuration) as api_client:
    ...
    api_instance = akeneo.PAMAssetApi(api_client)
...
with akeneo.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = akeneo.PAMAssetApi(api_client)
    body = akeneo.PatchPamAssetsRequest() # PatchPamAssetsRequest |  (optional)
...
with akeneo.ApiClient(configuration) as api_client:
    ...
    api_instance = akeneo.PAMAssetApi(api_client)
    code = 'code_example' # str | Code of the resource
    body = akeneo.PAMAssetsEmbeddedItemsInnerAllOf() # PAMAssetsEmbeddedItemsInnerAllOf | 
...
with akeneo.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = akeneo.PAMAssetApi(api_client)
    body = akeneo.PAMAssetsEmbeddedItemsInnerAllOf() # PAMAssetsEmbeddedItemsInnerAllOf |  (optional)
