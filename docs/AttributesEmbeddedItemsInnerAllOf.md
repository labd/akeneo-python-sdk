...
attributes_embedded_items_inner_all_of_instance = AttributesEmbeddedItemsInnerAllOf.from_json(json)
# print the JSON string representation of the object
print AttributesEmbeddedItemsInnerAllOf.to_json()

# convert the object into a dict
attributes_embedded_items_inner_all_of_dict = attributes_embedded_items_inner_all_of_instance.to_dict()
# create an instance of AttributesEmbeddedItemsInnerAllOf from a dict
attributes_embedded_items_inner_all_of_form_dict = attributes_embedded_items_inner_all_of.from_dict(attributes_embedded_items_inner_all_of_dict)
```
