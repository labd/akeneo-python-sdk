...
class SystemApi(object):
    ...
    def get_system_information(self, **kwargs) -> GetSystemInformation200Response:  # noqa: E501
        ...
        :rtype: GetSystemInformation200Response
        """
    ...
    def get_system_information_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetSystemInformation200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_system_information" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'version', 'edition', 'code', 'message'])  # noqa: E501
