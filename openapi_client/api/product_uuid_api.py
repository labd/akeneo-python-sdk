...
class ProductUuidApi(object):
    ...
    @validate_arguments
    def delete_products_uuid_uuid(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_products_uuid_uuid_with_http_info(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], **kwargs):  # noqa: E501
        """Delete a product  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_products_uuid_uuid" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_draft_uuid_uuid(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], **kwargs) -> Products1EmbeddedItemsInnerAllOf:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: Products1EmbeddedItemsInnerAllOf
        """
        kwargs['_return_http_data_only'] = True
        return self.get_draft_uuid_uuid_with_http_info(uuid, **kwargs)  # noqa: E501

    @validate_arguments
    def get_draft_uuid_uuid_with_http_info(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], **kwargs):  # noqa: E501
        """Get a draft  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Products1EmbeddedItemsInnerAllOf, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_draft_uuid_uuid" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "Products1EmbeddedItemsInnerAllOf",
    ...
    def get_products_uuid(self, search : Annotated[Optional[StrictStr], Field(description="Filter products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None, scope : Annotated[Optional[StrictStr], Field(description="Filter product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#via-channel\">Filter product values via channel</a> section")] = None, locales : Annotated[Optional[StrictStr], Field(description="Filter product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#via-locale\">Filter product values via locale</a> section")] = None, attributes : Annotated[Optional[StrictStr], Field(description="Filter product values to only return those concerning the given attributes, for more details see the <a href=\"/documentation/filter.html#filter-product-values\">Filter on product values</a> section")] = None, pagination_type : Annotated[Optional[StrictStr], Field(description="Pagination method type, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, page : Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None, search_after : Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, limit : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, with_count : Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None, with_attribute_options : Annotated[Optional[StrictBool], Field(description="Return labels of attribute options in the response. (Only available since the 5.0 version)")] = None, with_quality_scores : Annotated[Optional[StrictBool], Field(description="Return product quality scores in the response. (Only available since the 5.0 version)")] = None, with_completenesses : Annotated[Optional[StrictBool], Field(description="Return product completenesses in the response. (Only available since the 6.0 version)")] = None, **kwargs) -> Products1:  # noqa: E501
        ...
        >>> thread = api.get_products_uuid(search, scope, locales, attributes, pagination_type, page, search_after, limit, with_count, with_attribute_options, with_quality_scores, with_completenesses, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_products_uuid_with_http_info(search, scope, locales, attributes, pagination_type, page, search_after, limit, with_count, with_attribute_options, with_quality_scores, with_completenesses, **kwargs)  # noqa: E501

    @validate_arguments
    def get_products_uuid_with_http_info(self, search : Annotated[Optional[StrictStr], Field(description="Filter products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None, scope : Annotated[Optional[StrictStr], Field(description="Filter product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#via-channel\">Filter product values via channel</a> section")] = None, locales : Annotated[Optional[StrictStr], Field(description="Filter product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#via-locale\">Filter product values via locale</a> section")] = None, attributes : Annotated[Optional[StrictStr], Field(description="Filter product values to only return those concerning the given attributes, for more details see the <a href=\"/documentation/filter.html#filter-product-values\">Filter on product values</a> section")] = None, pagination_type : Annotated[Optional[StrictStr], Field(description="Pagination method type, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, page : Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None, search_after : Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, limit : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, with_count : Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None, with_attribute_options : Annotated[Optional[StrictBool], Field(description="Return labels of attribute options in the response. (Only available since the 5.0 version)")] = None, with_quality_scores : Annotated[Optional[StrictBool], Field(description="Return product quality scores in the response. (Only available since the 5.0 version)")] = None, with_completenesses : Annotated[Optional[StrictBool], Field(description="Return product completenesses in the response. (Only available since the 6.0 version)")] = None, **kwargs):  # noqa: E501
        """Get list of products  # noqa: E501
        ...
        >>> thread = api.get_products_uuid_with_http_info(search, scope, locales, attributes, pagination_type, page, search_after, limit, with_count, with_attribute_options, with_quality_scores, with_completenesses, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Products1, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_products_uuid" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_products_uuid_uuid(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], with_attribute_options : Annotated[Optional[StrictBool], Field(description="Return labels of attribute options in the response. (Only available since the 5.0 version)")] = None, with_quality_scores : Annotated[Optional[StrictBool], Field(description="Return product quality scores in the response. (Only available since the 5.0 version)")] = None, with_completenesses : Annotated[Optional[StrictBool], Field(description="Return product completenesses in the response. (Only available since the 6.0 version)")] = None, **kwargs) -> Products1EmbeddedItemsInnerAllOf:  # noqa: E501
        ...
        >>> thread = api.get_products_uuid_uuid(uuid, with_attribute_options, with_quality_scores, with_completenesses, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_products_uuid_uuid_with_http_info(uuid, with_attribute_options, with_quality_scores, with_completenesses, **kwargs)  # noqa: E501
    ...
    def get_products_uuid_uuid_with_http_info(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], with_attribute_options : Annotated[Optional[StrictBool], Field(description="Return labels of attribute options in the response. (Only available since the 5.0 version)")] = None, with_quality_scores : Annotated[Optional[StrictBool], Field(description="Return product quality scores in the response. (Only available since the 5.0 version)")] = None, with_completenesses : Annotated[Optional[StrictBool], Field(description="Return product completenesses in the response. (Only available since the 6.0 version)")] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_products_uuid_uuid_with_http_info(uuid, with_attribute_options, with_quality_scores, with_completenesses, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_products_uuid_uuid" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def patch_products_uuid(self, body : Optional[PatchProductsUuidRequest] = None, **kwargs) -> PatchProductsUuid200Response:  # noqa: E501
        ...
        >>> thread = api.patch_products_uuid(body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PatchProductsUuid200Response
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_products_uuid_with_http_info(body, **kwargs)  # noqa: E501

    @validate_arguments
    def patch_products_uuid_with_http_info(self, body : Optional[PatchProductsUuidRequest] = None, **kwargs):  # noqa: E501
        """Update/create several products  # noqa: E501
        ...
        >>> thread = api.patch_products_uuid_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PatchProductsUuid200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_products_uuid" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def patch_products_uuid_uuid(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], body : Products1EmbeddedItemsInnerAllOf, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.patch_products_uuid_uuid(uuid, body, async_req=True)
        >>> result = thread.get()

        :param uuid: Uuid of the resource (required)
        :type uuid: str
        :param body: (required)
        :type body: Products1EmbeddedItemsInnerAllOf
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_products_uuid_uuid_with_http_info(uuid, body, **kwargs)  # noqa: E501

    @validate_arguments
    def patch_products_uuid_uuid_with_http_info(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], body : Products1EmbeddedItemsInnerAllOf, **kwargs):  # noqa: E501
        """Update/create a product  # noqa: E501
        ...
        >>> thread = api.patch_products_uuid_uuid_with_http_info(uuid, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_products_uuid_uuid" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def post_products_uuid(self, body : Optional[Products1EmbeddedItemsInnerAllOf] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.post_products_uuid(body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_products_uuid_with_http_info(body, **kwargs)  # noqa: E501

    @validate_arguments
    def post_products_uuid_with_http_info(self, body : Optional[Products1EmbeddedItemsInnerAllOf] = None, **kwargs):  # noqa: E501
        """Create a new product  # noqa: E501
        ...
        >>> thread = api.post_products_uuid_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_products_uuid" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def post_proposal_uuid(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def post_proposal_uuid_with_http_info(self, uuid : Annotated[StrictStr, Field(..., description="Uuid of the resource")], **kwargs):  # noqa: E501
        """Submit a draft for approval  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_proposal_uuid" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
