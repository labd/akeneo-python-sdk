...
class PAMAssetApi(object):
    ...
    def get_pam_assets(self, pagination_type : Annotated[Optional[StrictStr], Field(description="Pagination method type, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, page : Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None, search_after : Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, limit : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, with_count : Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None, **kwargs) -> PAMAssets:  # noqa: E501
        ...
        >>> thread = api.get_pam_assets(pagination_type, page, search_after, limit, with_count, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_pam_assets_with_http_info(pagination_type, page, search_after, limit, with_count, **kwargs)  # noqa: E501

    @validate_arguments
    def get_pam_assets_with_http_info(self, pagination_type : Annotated[Optional[StrictStr], Field(description="Pagination method type, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, page : Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None, search_after : Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, limit : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, with_count : Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None, **kwargs):  # noqa: E501
        """Get list of PAM assets  # noqa: E501
        ...
        >>> thread = api.get_pam_assets_with_http_info(pagination_type, page, search_after, limit, with_count, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PAMAssets, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def get_pam_assets_code(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], **kwargs) -> PAMAssetsEmbeddedItemsInnerAllOf:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PAMAssetsEmbeddedItemsInnerAllOf
        """
        kwargs['_return_http_data_only'] = True
        return self.get_pam_assets_code_with_http_info(code, **kwargs)  # noqa: E501

    @validate_arguments
    def get_pam_assets_code_with_http_info(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], **kwargs):  # noqa: E501
        """Get a PAM asset  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PAMAssetsEmbeddedItemsInnerAllOf, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_pam_assets_code" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "PAMAssetsEmbeddedItemsInnerAllOf",
            '401': "GetProducts401Response",
            '403': "GetProducts401Response",
    ...
    @validate_arguments
    def patch_pam_assets(self, body : Optional[PatchPamAssetsRequest] = None, **kwargs) -> PatchProducts200Response:  # noqa: E501
        ...
        >>> thread = api.patch_pam_assets(body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_pam_assets_with_http_info(body, **kwargs)  # noqa: E501

    @validate_arguments
    def patch_pam_assets_with_http_info(self, body : Optional[PatchPamAssetsRequest] = None, **kwargs):  # noqa: E501
        """Update/create several PAM assets  # noqa: E501
        ...
        >>> thread = api.patch_pam_assets_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_pam_assets" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def patch_pam_assets_code(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], body : PAMAssetsEmbeddedItemsInnerAllOf, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.patch_pam_assets_code(code, body, async_req=True)
        >>> result = thread.get()

        :param code: Code of the resource (required)
        :type code: str
        :param body: (required)
        :type body: PAMAssetsEmbeddedItemsInnerAllOf
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_pam_assets_code_with_http_info(code, body, **kwargs)  # noqa: E501

    @validate_arguments
    def patch_pam_assets_code_with_http_info(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], body : PAMAssetsEmbeddedItemsInnerAllOf, **kwargs):  # noqa: E501
        """Update/create a PAM asset  # noqa: E501
        ...
        >>> thread = api.patch_pam_assets_code_with_http_info(code, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_pam_assets_code" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def post_pam_assets(self, body : Optional[PAMAssetsEmbeddedItemsInnerAllOf] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.post_pam_assets(body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_pam_assets_with_http_info(body, **kwargs)  # noqa: E501

    @validate_arguments
    def post_pam_assets_with_http_info(self, body : Optional[PAMAssetsEmbeddedItemsInnerAllOf] = None, **kwargs):  # noqa: E501
        """Create a new PAM asset  # noqa: E501
        ...
        >>> thread = api.post_pam_assets_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_pam_assets" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
