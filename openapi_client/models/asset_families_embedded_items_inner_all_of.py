...
class AssetFamiliesEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetFamiliesEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetFamiliesEmbeddedItemsInnerAllOf:
        """Create an instance of AssetFamiliesEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssetFamiliesEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = AssetFamiliesEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
