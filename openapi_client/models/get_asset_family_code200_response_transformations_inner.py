...
class GetAssetFamilyCode200ResponseTransformationsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetFamilyCode200ResponseTransformationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetFamilyCode200ResponseTransformationsInner:
        """Create an instance of GetAssetFamilyCode200ResponseTransformationsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAssetFamilyCode200ResponseTransformationsInner.parse_obj(obj)

        _obj = GetAssetFamilyCode200ResponseTransformationsInner.parse_obj({
            "label": obj.get("label"),
            "filename_suffix": obj.get("filename_suffix"),
            "filename_prefix": obj.get("filename_prefix"),
            "source": GetAssetFamilyCode200ResponseTransformationsInnerSource.from_dict(obj.get("source")) if obj.get("source") is not None else None,
            "target": GetAssetFamilyCode200ResponseTransformationsInnerTarget.from_dict(obj.get("target")) if obj.get("target") is not None else None,
            "operations": GetAssetFamilyCode200ResponseTransformationsInnerOperations.from_dict(obj.get("operations")) if obj.get("operations") is not None else None
        })
        return _obj
