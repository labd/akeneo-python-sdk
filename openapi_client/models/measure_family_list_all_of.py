...
class MeasureFamilyListAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeasureFamilyListAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeasureFamilyListAllOf:
        """Create an instance of MeasureFamilyListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MeasureFamilyListAllOf.parse_obj(obj)

        _obj = MeasureFamilyListAllOf.parse_obj({
            "code": obj.get("code"),
