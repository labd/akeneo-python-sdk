...
class PatchReferenceEntityRecordsRequestInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchReferenceEntityRecordsRequestInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchReferenceEntityRecordsRequestInner:
        """Create an instance of PatchReferenceEntityRecordsRequestInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchReferenceEntityRecordsRequestInner.parse_obj(obj)

        _obj = PatchReferenceEntityRecordsRequestInner.parse_obj({
            "code": obj.get("code"),
