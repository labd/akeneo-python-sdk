...
class ErrorByLineProductUuid(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorByLineProductUuid:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ErrorByLineProductUuid:
        """Create an instance of ErrorByLineProductUuid from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ErrorByLineProductUuid.parse_obj(obj)

        _obj = ErrorByLineProductUuid.parse_obj({
            "line": obj.get("line"),
            "uuid": obj.get("uuid"),
