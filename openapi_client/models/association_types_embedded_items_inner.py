...
class AssociationTypesEmbeddedItemsInner(BaseModel):
    ...
    __properties = ["_links", "code", "labels", "is_quantified", "is_two_way"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssociationTypesEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssociationTypesEmbeddedItemsInner:
        """Create an instance of AssociationTypesEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssociationTypesEmbeddedItemsInner.parse_obj(obj)

        _obj = AssociationTypesEmbeddedItemsInner.parse_obj({
