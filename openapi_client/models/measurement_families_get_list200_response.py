...
class MeasurementFamiliesGetList200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeasurementFamiliesGetList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeasurementFamiliesGetList200Response:
