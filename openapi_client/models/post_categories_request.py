...
class PostCategoriesRequest(BaseModel):
    ...
    labels: Optional[PostCategoriesRequestLabels] = None
    values: Optional[PostCategoriesRequestValues] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostCategoriesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostCategoriesRequest:
        """Create an instance of PostCategoriesRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostCategoriesRequest.parse_obj(obj)

        _obj = PostCategoriesRequest.parse_obj({
            "code": obj.get("code"),
            "parent": obj.get("parent") if obj.get("parent") is not None else 'null',
            "updated": obj.get("updated"),
            "position": obj.get("position"),
            "labels": PostCategoriesRequestLabels.from_dict(obj.get("labels")) if obj.get("labels") is not None else None,
            "values": PostCategoriesRequestValues.from_dict(obj.get("values")) if obj.get("values") is not None else None
        })
        return _obj
