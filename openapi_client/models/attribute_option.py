...
class AttributeOption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeOption:
        """Create an instance of AttributeOption from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeOption.parse_obj(obj)

        _obj = AttributeOption.parse_obj({
            "code": obj.get("code"),
