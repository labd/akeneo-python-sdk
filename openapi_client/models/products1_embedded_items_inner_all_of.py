...
class Products1EmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Products1EmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Products1EmbeddedItemsInnerAllOf:
        """Create an instance of Products1EmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Products1EmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = Products1EmbeddedItemsInnerAllOf.parse_obj({
            "uuid": obj.get("uuid"),
