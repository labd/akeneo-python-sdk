...
class ReferenceEntityAllOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceEntityAllOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceEntityAllOf1:
        """Create an instance of ReferenceEntityAllOf1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ReferenceEntityAllOf1.parse_obj(obj)

        _obj = ReferenceEntityAllOf1.parse_obj({
            "code": obj.get("code"),
