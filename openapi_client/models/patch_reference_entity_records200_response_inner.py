...
class PatchReferenceEntityRecords200ResponseInner(BaseModel):
    ...
    __properties = ["code", "status_code", "message"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchReferenceEntityRecords200ResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchReferenceEntityRecords200ResponseInner:
        """Create an instance of PatchReferenceEntityRecords200ResponseInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchReferenceEntityRecords200ResponseInner.parse_obj(obj)

        _obj = PatchReferenceEntityRecords200ResponseInner.parse_obj({
            "code": obj.get("code"),
