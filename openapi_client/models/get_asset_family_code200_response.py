...
class GetAssetFamilyCode200Response(BaseModel):
    ...
    labels: Optional[GetAssetFamilyCode200ResponseLabels] = None
    ...
    naming_convention: Optional[GetAssetFamilyCode200ResponseNamingConvention] = None
    product_link_rules: Optional[List[GetAssetFamilyCode200ResponseProductLinkRulesInner]] = Field(None, description="The rules that will be run after the asset creation, in order to automatically link the assets of this family to a set of products. To understand the format of this property, see <a href='/concepts/asset-manager.html#focus-on-the-product-link-rule'>here</a>.")
    transformations: Optional[List[GetAssetFamilyCode200ResponseTransformationsInner]] = Field(None, description="The transformations to perform on source files in order to generate new files into your asset attributes (only available since v4.0). To understand the format of this property, see <a href='/concepts/asset-manager.html#focus-on-the-transformations'>here</a>.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetFamilyCode200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetFamilyCode200Response:
        """Create an instance of GetAssetFamilyCode200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAssetFamilyCode200Response.parse_obj(obj)

        _obj = GetAssetFamilyCode200Response.parse_obj({
            "code": obj.get("code"),
            "labels": GetAssetFamilyCode200ResponseLabels.from_dict(obj.get("labels")) if obj.get("labels") is not None else None,
            ...
            "naming_convention": GetAssetFamilyCode200ResponseNamingConvention.from_dict(obj.get("naming_convention")) if obj.get("naming_convention") is not None else None,
            "product_link_rules": [GetAssetFamilyCode200ResponseProductLinkRulesInner.from_dict(_item) for _item in obj.get("product_link_rules")] if obj.get("product_link_rules") is not None else None,
            "transformations": [GetAssetFamilyCode200ResponseTransformationsInner.from_dict(_item) for _item in obj.get("transformations")] if obj.get("transformations") is not None else None
        })
        return _obj
