...
class Locales(BaseModel):
    ...
    """
    embedded: Optional[LocalesEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Locales:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Locales:
        """Create an instance of Locales from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Locales.parse_obj(obj)

        _obj = Locales.parse_obj({
            "embedded": LocalesEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
