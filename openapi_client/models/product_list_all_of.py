...
class ProductListAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductListAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductListAllOf:
        """Create an instance of ProductListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductListAllOf.parse_obj(obj)

        _obj = ProductListAllOf.parse_obj({
