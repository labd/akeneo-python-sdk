...
class ChannelListAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelListAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelListAllOf:
        """Create an instance of ChannelListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ChannelListAllOf.parse_obj(obj)

        _obj = ChannelListAllOf.parse_obj({
            "code": obj.get("code"),
