...
class GetAssetFamilyCode200ResponseNamingConvention(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetFamilyCode200ResponseNamingConvention:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetFamilyCode200ResponseNamingConvention:
        """Create an instance of GetAssetFamilyCode200ResponseNamingConvention from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAssetFamilyCode200ResponseNamingConvention.parse_obj(obj)

        _obj = GetAssetFamilyCode200ResponseNamingConvention.parse_obj({
