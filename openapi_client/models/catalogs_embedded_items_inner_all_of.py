...
class CatalogsEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogsEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogsEmbeddedItemsInnerAllOf:
        """Create an instance of CatalogsEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CatalogsEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = CatalogsEmbeddedItemsInnerAllOf.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
