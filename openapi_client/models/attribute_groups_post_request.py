...
class AttributeGroupsPostRequest(BaseModel):
    ...
    labels: Optional[AttributeGroupsPostRequestLabels] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeGroupsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeGroupsPostRequest:
        """Create an instance of AttributeGroupsPostRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeGroupsPostRequest.parse_obj(obj)

        _obj = AttributeGroupsPostRequest.parse_obj({
            "code": obj.get("code"),
            "sort_order": obj.get("sort_order"),
            "attributes": obj.get("attributes"),
            "labels": AttributeGroupsPostRequestLabels.from_dict(obj.get("labels")) if obj.get("labels") is not None else None
        })
        return _obj
