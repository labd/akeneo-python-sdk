...
class AssociationTypesPostRequest(BaseModel):
    ...
    labels: Optional[AssociationTypesPostRequestLabels] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssociationTypesPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssociationTypesPostRequest:
        """Create an instance of AssociationTypesPostRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssociationTypesPostRequest.parse_obj(obj)

        _obj = AssociationTypesPostRequest.parse_obj({
            "code": obj.get("code"),
            "labels": AssociationTypesPostRequestLabels.from_dict(obj.get("labels")) if obj.get("labels") is not None else None,
