...
class ProductsEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductsEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductsEmbeddedItemsInnerAllOf:
        """Create an instance of ProductsEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductsEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = ProductsEmbeddedItemsInnerAllOf.parse_obj({
