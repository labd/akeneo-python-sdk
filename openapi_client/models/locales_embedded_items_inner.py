...
class LocalesEmbeddedItemsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocalesEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LocalesEmbeddedItemsInner:
        """Create an instance of LocalesEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return LocalesEmbeddedItemsInner.parse_obj(obj)

        _obj = LocalesEmbeddedItemsInner.parse_obj({
