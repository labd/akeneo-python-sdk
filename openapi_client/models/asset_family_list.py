...
class AssetFamilyList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetFamilyList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetFamilyList:
        """Create an instance of AssetFamilyList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssetFamilyList.parse_obj(obj)

        _obj = AssetFamilyList.parse_obj({
