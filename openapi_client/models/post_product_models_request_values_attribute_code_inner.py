...
class PostProductModelsRequestValuesAttributeCodeInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostProductModelsRequestValuesAttributeCodeInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostProductModelsRequestValuesAttributeCodeInner:
        """Create an instance of PostProductModelsRequestValuesAttributeCodeInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostProductModelsRequestValuesAttributeCodeInner.parse_obj(obj)

        _obj = PostProductModelsRequestValuesAttributeCodeInner.parse_obj({
            "scope": obj.get("scope"),
