...
class MeasureFamilies(BaseModel):
    ...
    """
    embedded: Optional[MeasureFamiliesEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeasureFamilies:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeasureFamilies:
        """Create an instance of MeasureFamilies from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MeasureFamilies.parse_obj(obj)

        _obj = MeasureFamilies.parse_obj({
            "embedded": MeasureFamiliesEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
