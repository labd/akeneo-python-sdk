...
class GetAssetsCode200Response(BaseModel):
    ...
    values: Optional[PatchAssetsRequestInnerValues] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAssetsCode200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAssetsCode200Response:
        """Create an instance of GetAssetsCode200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAssetsCode200Response.parse_obj(obj)

        _obj = GetAssetsCode200Response.parse_obj({
            "code": obj.get("code"),
            "values": PatchAssetsRequestInnerValues.from_dict(obj.get("values")) if obj.get("values") is not None else None,
