...
class ChannelsEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ChannelsEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ChannelsEmbeddedItemsInnerAllOf:
        """Create an instance of ChannelsEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ChannelsEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = ChannelsEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
