...
class AssetFamiliesEmbeddedItemsInnerAllOfNamingConvention(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetFamiliesEmbeddedItemsInnerAllOfNamingConvention:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetFamiliesEmbeddedItemsInnerAllOfNamingConvention:
        """Create an instance of AssetFamiliesEmbeddedItemsInnerAllOfNamingConvention from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssetFamiliesEmbeddedItemsInnerAllOfNamingConvention.parse_obj(obj)

        _obj = AssetFamiliesEmbeddedItemsInnerAllOfNamingConvention.parse_obj({
