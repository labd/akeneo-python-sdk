...
class PatchFamiliesFamilyCodeVariantsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchFamiliesFamilyCodeVariantsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchFamiliesFamilyCodeVariantsRequest:
        """Create an instance of PatchFamiliesFamilyCodeVariantsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchFamiliesFamilyCodeVariantsRequest.parse_obj(obj)

        _obj = PatchFamiliesFamilyCodeVariantsRequest.parse_obj({
            "code": obj.get("code"),
