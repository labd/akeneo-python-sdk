...
class PatchProductsUuidRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchProductsUuidRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchProductsUuidRequest:
        """Create an instance of PatchProductsUuidRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchProductsUuidRequest.parse_obj(obj)

        _obj = PatchProductsUuidRequest.parse_obj({
            "uuid": obj.get("uuid"),
