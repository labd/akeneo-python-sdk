...
class PostProductsRequest(BaseModel):
    ...
    quantified_associations: Optional[PostProductsRequestQuantifiedAssociations] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostProductsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostProductsRequest:
        """Create an instance of PostProductsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostProductsRequest.parse_obj(obj)

        _obj = PostProductsRequest.parse_obj({
            "uuid": obj.get("uuid"),
            ...
            "quantified_associations": PostProductsRequestQuantifiedAssociations.from_dict(obj.get("quantified_associations")) if obj.get("quantified_associations") is not None else None,
