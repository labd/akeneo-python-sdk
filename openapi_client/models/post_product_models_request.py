...
class PostProductModelsRequest(BaseModel):
    ...
    values: Optional[PostProductModelsRequestValues] = None
    associations: Optional[PostProductModelsRequestAssociations] = None
    quantified_associations: Optional[PostProductModelsRequestQuantifiedAssociations] = None
    ...
    metadata: Optional[PostProductModelsRequestMetadata] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostProductModelsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostProductModelsRequest:
        """Create an instance of PostProductModelsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostProductModelsRequest.parse_obj(obj)

        _obj = PostProductModelsRequest.parse_obj({
            "code": obj.get("code"),
            "family": obj.get("family"),
            "family_variant": obj.get("family_variant"),
            "parent": obj.get("parent") if obj.get("parent") is not None else 'null',
            "categories": obj.get("categories"),
            "values": PostProductModelsRequestValues.from_dict(obj.get("values")) if obj.get("values") is not None else None,
            "associations": PostProductModelsRequestAssociations.from_dict(obj.get("associations")) if obj.get("associations") is not None else None,
            "quantified_associations": PostProductModelsRequestQuantifiedAssociations.from_dict(obj.get("quantified_associations")) if obj.get("quantified_associations") is not None else None,
            "created": obj.get("created"),
            "updated": obj.get("updated"),
            "metadata": PostProductModelsRequestMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
