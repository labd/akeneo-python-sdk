...
class Catalogs(BaseModel):
    ...
    """
    embedded: Optional[CatalogsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Catalogs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Catalogs:
        """Create an instance of Catalogs from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Catalogs.parse_obj(obj)

        _obj = Catalogs.parse_obj({
            "embedded": CatalogsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
