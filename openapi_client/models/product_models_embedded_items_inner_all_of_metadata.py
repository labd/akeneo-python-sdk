...
class ProductModelsEmbeddedItemsInnerAllOfMetadata(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    workflow_status: Optional[StrictStr] = Field(None, description="Status of the product model regarding the user permissions")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductModelsEmbeddedItemsInnerAllOfMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductModelsEmbeddedItemsInnerAllOfMetadata:
        """Create an instance of ProductModelsEmbeddedItemsInnerAllOfMetadata from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductModelsEmbeddedItemsInnerAllOfMetadata.parse_obj(obj)

        _obj = ProductModelsEmbeddedItemsInnerAllOfMetadata.parse_obj({
