...
class Channels(BaseModel):
    ...
    """
    embedded: Optional[ChannelsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Channels:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Channels:
        """Create an instance of Channels from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Channels.parse_obj(obj)

        _obj = Channels.parse_obj({
            "embedded": ChannelsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
