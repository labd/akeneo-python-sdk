...
class PostProductModelsRequestMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostProductModelsRequestMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostProductModelsRequestMetadata:
        """Create an instance of PostProductModelsRequestMetadata from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostProductModelsRequestMetadata.parse_obj(obj)

        _obj = PostProductModelsRequestMetadata.parse_obj({
