...
class ReferenceEntityAttributeOption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceEntityAttributeOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceEntityAttributeOption:
        """Create an instance of ReferenceEntityAttributeOption from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ReferenceEntityAttributeOption.parse_obj(obj)

        _obj = ReferenceEntityAttributeOption.parse_obj({
            "code": obj.get("code"),
