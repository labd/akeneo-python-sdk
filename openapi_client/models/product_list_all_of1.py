...
class ProductListAllOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductListAllOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductListAllOf1:
        """Create an instance of ProductListAllOf1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductListAllOf1.parse_obj(obj)

        _obj = ProductListAllOf1.parse_obj({
            "uuid": obj.get("uuid"),
