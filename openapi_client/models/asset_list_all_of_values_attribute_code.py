...
class AssetListAllOfValuesAttributeCode(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetListAllOfValuesAttributeCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetListAllOfValuesAttributeCode:
        """Create an instance of AssetListAllOfValuesAttributeCode from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssetListAllOfValuesAttributeCode.parse_obj(obj)

        _obj = AssetListAllOfValuesAttributeCode.parse_obj({
