...
class ReferenceEntityRecordListAllOfValuesAttributeCode(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceEntityRecordListAllOfValuesAttributeCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceEntityRecordListAllOfValuesAttributeCode:
        """Create an instance of ReferenceEntityRecordListAllOfValuesAttributeCode from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ReferenceEntityRecordListAllOfValuesAttributeCode.parse_obj(obj)

        _obj = ReferenceEntityRecordListAllOfValuesAttributeCode.parse_obj({
