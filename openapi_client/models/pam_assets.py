...
class PAMAssets(BaseModel):
    ...
    """
    embedded: Optional[PAMAssetsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PAMAssets:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PAMAssets:
        """Create an instance of PAMAssets from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PAMAssets.parse_obj(obj)

        _obj = PAMAssets.parse_obj({
            "embedded": PAMAssetsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
