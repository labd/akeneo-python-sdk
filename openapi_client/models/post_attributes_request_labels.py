...
class PostAttributesRequestLabels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostAttributesRequestLabels:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostAttributesRequestLabels:
        """Create an instance of PostAttributesRequestLabels from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostAttributesRequestLabels.parse_obj(obj)

        _obj = PostAttributesRequestLabels.parse_obj({
