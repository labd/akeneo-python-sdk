...
class Categories(BaseModel):
    ...
    """
    embedded: Optional[CategoriesEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Categories:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Categories:
        """Create an instance of Categories from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Categories.parse_obj(obj)

        _obj = Categories.parse_obj({
            "embedded": CategoriesEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
