...
class ReferenceEntityRecordEmbeddedItemsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceEntityRecordEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceEntityRecordEmbeddedItemsInner:
