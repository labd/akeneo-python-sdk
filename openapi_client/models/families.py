...
class Families(BaseModel):
    ...
    """
    embedded: Optional[FamiliesEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Families:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Families:
        """Create an instance of Families from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Families.parse_obj(obj)

        _obj = Families.parse_obj({
            "embedded": FamiliesEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
