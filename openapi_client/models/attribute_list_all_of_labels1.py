...
class AttributeListAllOfLabels1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeListAllOfLabels1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeListAllOfLabels1:
        """Create an instance of AttributeListAllOfLabels1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeListAllOfLabels1.parse_obj(obj)

        _obj = AttributeListAllOfLabels1.parse_obj({
