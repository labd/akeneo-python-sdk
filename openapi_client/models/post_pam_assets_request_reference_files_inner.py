...
class PostPamAssetsRequestReferenceFilesInner(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    link: Optional[PostPamAssetsRequestReferenceFilesInnerLink] = Field(None, alias="_link")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostPamAssetsRequestReferenceFilesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostPamAssetsRequestReferenceFilesInner:
        """Create an instance of PostPamAssetsRequestReferenceFilesInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostPamAssetsRequestReferenceFilesInner.parse_obj(obj)

        _obj = PostPamAssetsRequestReferenceFilesInner.parse_obj({
            "link": PostPamAssetsRequestReferenceFilesInnerLink.from_dict(obj.get("_link")) if obj.get("_link") is not None else None,
