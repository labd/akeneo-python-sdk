...
class PatchAssetsRequestInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchAssetsRequestInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchAssetsRequestInner:
        """Create an instance of PatchAssetsRequestInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchAssetsRequestInner.parse_obj(obj)

        _obj = PatchAssetsRequestInner.parse_obj({
            "code": obj.get("code"),
