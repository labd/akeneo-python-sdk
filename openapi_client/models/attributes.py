...
class Attributes(BaseModel):
    ...
    """
    embedded: Optional[AttributesEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Attributes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Attributes:
        """Create an instance of Attributes from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Attributes.parse_obj(obj)

        _obj = Attributes.parse_obj({
            "embedded": AttributesEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
