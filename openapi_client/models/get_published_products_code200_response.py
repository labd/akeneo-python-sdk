...
class GetPublishedProductsCode200Response(BaseModel):
    ...
    values: Optional[GetPublishedProductsCode200ResponseValues] = None
    associations: Optional[GetPublishedProductsCode200ResponseAssociations] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPublishedProductsCode200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPublishedProductsCode200Response:
        """Create an instance of GetPublishedProductsCode200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetPublishedProductsCode200Response.parse_obj(obj)

        _obj = GetPublishedProductsCode200Response.parse_obj({
            "identifier": obj.get("identifier"),
            "enabled": obj.get("enabled") if obj.get("enabled") is not None else True,
            "family": obj.get("family") if obj.get("family") is not None else 'null',
            "categories": obj.get("categories"),
            "groups": obj.get("groups"),
            "values": GetPublishedProductsCode200ResponseValues.from_dict(obj.get("values")) if obj.get("values") is not None else None,
            "associations": GetPublishedProductsCode200ResponseAssociations.from_dict(obj.get("associations")) if obj.get("associations") is not None else None,
