...
class PAMAssetTagsEmbeddedItemsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PAMAssetTagsEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PAMAssetTagsEmbeddedItemsInner:
        """Create an instance of PAMAssetTagsEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PAMAssetTagsEmbeddedItemsInner.parse_obj(obj)

        _obj = PAMAssetTagsEmbeddedItemsInner.parse_obj({
