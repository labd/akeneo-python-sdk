...
class DeprecatedAssetListAllOfReferenceFiles(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    link: Optional[DeprecatedAssetListAllOfLink1] = Field(None, alias="_link")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeprecatedAssetListAllOfReferenceFiles:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeprecatedAssetListAllOfReferenceFiles:
        """Create an instance of DeprecatedAssetListAllOfReferenceFiles from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DeprecatedAssetListAllOfReferenceFiles.parse_obj(obj)

        _obj = DeprecatedAssetListAllOfReferenceFiles.parse_obj({
            "link": DeprecatedAssetListAllOfLink1.from_dict(obj.get("_link")) if obj.get("_link") is not None else None,
