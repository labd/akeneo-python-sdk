...
class PatchReferenceEntityRecordsRequestInnerValuesAttributeCodeInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchReferenceEntityRecordsRequestInnerValuesAttributeCodeInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchReferenceEntityRecordsRequestInnerValuesAttributeCodeInner:
        """Create an instance of PatchReferenceEntityRecordsRequestInnerValuesAttributeCodeInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchReferenceEntityRecordsRequestInnerValuesAttributeCodeInner.parse_obj(obj)

        _obj = PatchReferenceEntityRecordsRequestInnerValuesAttributeCodeInner.parse_obj({
