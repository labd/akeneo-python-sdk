...
class GetMediaFilesCode200Response(BaseModel):
    ...
    """
    links: Optional[GetMediaFilesCode200ResponseLinks] = Field(None, alias="_links")
    ...
    __properties = ["_links", "code", "extension", "mime_type", "original_filename", "size"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetMediaFilesCode200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetMediaFilesCode200Response:
        """Create an instance of GetMediaFilesCode200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetMediaFilesCode200Response.parse_obj(obj)

        _obj = GetMediaFilesCode200Response.parse_obj({
            "links": GetMediaFilesCode200ResponseLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "code": obj.get("code"),
