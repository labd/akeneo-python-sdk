...
class ReferenceEntityRecordItemList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceEntityRecordItemList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceEntityRecordItemList:
        """Create an instance of ReferenceEntityRecordItemList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ReferenceEntityRecordItemList.parse_obj(obj)

        _obj = ReferenceEntityRecordItemList.parse_obj({
