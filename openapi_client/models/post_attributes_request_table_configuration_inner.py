...
class PostAttributesRequestTableConfigurationInner(BaseModel):
    ...
    validations: Optional[PostAttributesRequestTableConfigurationInnerValidations] = None
    labels: Optional[PostAttributesRequestTableConfigurationInnerLabels] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostAttributesRequestTableConfigurationInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostAttributesRequestTableConfigurationInner:
        """Create an instance of PostAttributesRequestTableConfigurationInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostAttributesRequestTableConfigurationInner.parse_obj(obj)

        _obj = PostAttributesRequestTableConfigurationInner.parse_obj({
            "code": obj.get("code"),
            "data_type": obj.get("data_type"),
            "validations": PostAttributesRequestTableConfigurationInnerValidations.from_dict(obj.get("validations")) if obj.get("validations") is not None else None,
            "labels": PostAttributesRequestTableConfigurationInnerLabels.from_dict(obj.get("labels")) if obj.get("labels") is not None else None,
