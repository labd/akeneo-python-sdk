...
class PAMAssetTags(BaseModel):
    ...
    """
    embedded: Optional[PAMAssetTagsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PAMAssetTags:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PAMAssetTags:
        """Create an instance of PAMAssetTags from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PAMAssetTags.parse_obj(obj)

        _obj = PAMAssetTags.parse_obj({
            "embedded": PAMAssetTagsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
