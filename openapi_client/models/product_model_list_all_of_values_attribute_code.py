...
class ProductModelListAllOfValuesAttributeCode(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductModelListAllOfValuesAttributeCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductModelListAllOfValuesAttributeCode:
        """Create an instance of ProductModelListAllOfValuesAttributeCode from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductModelListAllOfValuesAttributeCode.parse_obj(obj)

        _obj = ProductModelListAllOfValuesAttributeCode.parse_obj({
            "scope": obj.get("scope"),
