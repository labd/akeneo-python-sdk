...
class GetReferenceEntityRecordsCode200Response(BaseModel):
    ...
    values: Optional[PatchReferenceEntityRecordsRequestInnerValues] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReferenceEntityRecordsCode200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReferenceEntityRecordsCode200Response:
        """Create an instance of GetReferenceEntityRecordsCode200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetReferenceEntityRecordsCode200Response.parse_obj(obj)

        _obj = GetReferenceEntityRecordsCode200Response.parse_obj({
            "code": obj.get("code"),
            "values": PatchReferenceEntityRecordsRequestInnerValues.from_dict(obj.get("values")) if obj.get("values") is not None else None,
