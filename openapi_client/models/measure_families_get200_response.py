...
class MeasureFamiliesGet200Response(BaseModel):
    ...
    units: Optional[List[MeasureFamiliesGet200ResponseUnitsInner]] = Field(None, description="Family units")
    __properties = ["code", "standard", "units"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeasureFamiliesGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeasureFamiliesGet200Response:
        """Create an instance of MeasureFamiliesGet200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MeasureFamiliesGet200Response.parse_obj(obj)

        _obj = MeasureFamiliesGet200Response.parse_obj({
            "code": obj.get("code"),
            "standard": obj.get("standard"),
            "units": [MeasureFamiliesGet200ResponseUnitsInner.from_dict(_item) for _item in obj.get("units")] if obj.get("units") is not None else None
        })
        return _obj
