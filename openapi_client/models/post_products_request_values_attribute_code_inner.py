...
class PostProductsRequestValuesAttributeCodeInner(BaseModel):
    ...
    linked_data: Optional[PostProductsRequestValuesAttributeCodeInnerLinkedData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostProductsRequestValuesAttributeCodeInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostProductsRequestValuesAttributeCodeInner:
        """Create an instance of PostProductsRequestValuesAttributeCodeInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostProductsRequestValuesAttributeCodeInner.parse_obj(obj)

        _obj = PostProductsRequestValuesAttributeCodeInner.parse_obj({
            "scope": obj.get("scope"),
            "locale": obj.get("locale"),
            "data": obj.get("data"),
            "linked_data": PostProductsRequestValuesAttributeCodeInnerLinkedData.from_dict(obj.get("linked_data")) if obj.get("linked_data") is not None else None
        })
        return _obj
