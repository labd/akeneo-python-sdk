...
class ProductListAllOf1ValuesAttributeCode(BaseModel):
    ...
    linked_data: Optional[ProductListAllOf1ValuesLinkedData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductListAllOf1ValuesAttributeCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductListAllOf1ValuesAttributeCode:
        """Create an instance of ProductListAllOf1ValuesAttributeCode from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductListAllOf1ValuesAttributeCode.parse_obj(obj)

        _obj = ProductListAllOf1ValuesAttributeCode.parse_obj({
            "scope": obj.get("scope"),
            "locale": obj.get("locale"),
            "data": obj.get("data"),
            "linked_data": ProductListAllOf1ValuesLinkedData.from_dict(obj.get("linked_data")) if obj.get("linked_data") is not None else None
        })
        return _obj
