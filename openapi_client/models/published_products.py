...
class PublishedProducts(BaseModel):
    ...
    """
    embedded: Optional[PublishedProductsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublishedProducts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublishedProducts:
        """Create an instance of PublishedProducts from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PublishedProducts.parse_obj(obj)

        _obj = PublishedProducts.parse_obj({
            "embedded": PublishedProductsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
