...
class AttributesEmbeddedItemsInnerAllOfTableConfigurationInner(BaseModel):
    ...
    validations: Optional[AttributesEmbeddedItemsInnerAllOfTableConfigurationInnerValidations] = None
    labels: Optional[AttributesEmbeddedItemsInnerAllOfTableConfigurationInnerLabels] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributesEmbeddedItemsInnerAllOfTableConfigurationInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributesEmbeddedItemsInnerAllOfTableConfigurationInner:
        """Create an instance of AttributesEmbeddedItemsInnerAllOfTableConfigurationInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributesEmbeddedItemsInnerAllOfTableConfigurationInner.parse_obj(obj)

        _obj = AttributesEmbeddedItemsInnerAllOfTableConfigurationInner.parse_obj({
            "code": obj.get("code"),
            "data_type": obj.get("data_type"),
            "validations": AttributesEmbeddedItemsInnerAllOfTableConfigurationInnerValidations.from_dict(obj.get("validations")) if obj.get("validations") is not None else None,
            "labels": AttributesEmbeddedItemsInnerAllOfTableConfigurationInnerLabels.from_dict(obj.get("labels")) if obj.get("labels") is not None else None,
