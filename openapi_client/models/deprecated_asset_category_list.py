...
class DeprecatedAssetCategoryList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeprecatedAssetCategoryList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeprecatedAssetCategoryList:
        """Create an instance of DeprecatedAssetCategoryList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DeprecatedAssetCategoryList.parse_obj(obj)

        _obj = DeprecatedAssetCategoryList.parse_obj({
