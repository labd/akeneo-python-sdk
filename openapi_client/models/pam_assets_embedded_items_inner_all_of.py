...
class PAMAssetsEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PAMAssetsEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PAMAssetsEmbeddedItemsInnerAllOf:
        """Create an instance of PAMAssetsEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PAMAssetsEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = PAMAssetsEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
