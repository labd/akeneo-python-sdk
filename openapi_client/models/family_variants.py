...
class FamilyVariants(BaseModel):
    ...
    """
    embedded: Optional[FamilyVariantsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FamilyVariants:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FamilyVariants:
        """Create an instance of FamilyVariants from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FamilyVariants.parse_obj(obj)

        _obj = FamilyVariants.parse_obj({
            "embedded": FamilyVariantsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
