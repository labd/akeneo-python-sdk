...
class PostProductsRequestMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostProductsRequestMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostProductsRequestMetadata:
        """Create an instance of PostProductsRequestMetadata from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostProductsRequestMetadata.parse_obj(obj)

        _obj = PostProductsRequestMetadata.parse_obj({
