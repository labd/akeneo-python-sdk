...
class ProductModelsEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductModelsEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductModelsEmbeddedItemsInnerAllOf:
        """Create an instance of ProductModelsEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductModelsEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = ProductModelsEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
