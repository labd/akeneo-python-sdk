...
class AttributeOptions(BaseModel):
    ...
    """
    embedded: Optional[AttributeOptionsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeOptions:
        """Create an instance of AttributeOptions from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeOptions.parse_obj(obj)

        _obj = AttributeOptions.parse_obj({
            "embedded": AttributeOptionsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
