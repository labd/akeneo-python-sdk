...
class AttributeListAllOfLabels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeListAllOfLabels:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeListAllOfLabels:
        """Create an instance of AttributeListAllOfLabels from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeListAllOfLabels.parse_obj(obj)

        _obj = AttributeListAllOfLabels.parse_obj({
