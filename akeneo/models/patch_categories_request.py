...
class PatchCategoriesRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchCategoriesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchCategoriesRequest:
        """Create an instance of PatchCategoriesRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchCategoriesRequest.parse_obj(obj)

        _obj = PatchCategoriesRequest.parse_obj({
            "code": obj.get("code"),
