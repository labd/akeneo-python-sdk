...
class PublishedProductsEmbeddedItemsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublishedProductsEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublishedProductsEmbeddedItemsInner:
        """Create an instance of PublishedProductsEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PublishedProductsEmbeddedItemsInner.parse_obj(obj)

        _obj = PublishedProductsEmbeddedItemsInner.parse_obj({
