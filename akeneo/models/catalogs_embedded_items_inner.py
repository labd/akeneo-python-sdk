...
class CatalogsEmbeddedItemsInner(BaseModel):
    ...
    __properties = ["_links", "id", "name", "enabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogsEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogsEmbeddedItemsInner:
        """Create an instance of CatalogsEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CatalogsEmbeddedItemsInner.parse_obj(obj)

        _obj = CatalogsEmbeddedItemsInner.parse_obj({
