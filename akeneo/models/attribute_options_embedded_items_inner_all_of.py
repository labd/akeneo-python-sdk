...
class AttributeOptionsEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeOptionsEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeOptionsEmbeddedItemsInnerAllOf:
        """Create an instance of AttributeOptionsEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeOptionsEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = AttributeOptionsEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
