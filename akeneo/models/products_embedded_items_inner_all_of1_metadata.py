...
class ProductsEmbeddedItemsInnerAllOf1Metadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductsEmbeddedItemsInnerAllOf1Metadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductsEmbeddedItemsInnerAllOf1Metadata:
        """Create an instance of ProductsEmbeddedItemsInnerAllOf1Metadata from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductsEmbeddedItemsInnerAllOf1Metadata.parse_obj(obj)

        _obj = ProductsEmbeddedItemsInnerAllOf1Metadata.parse_obj({
