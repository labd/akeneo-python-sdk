...
class AssociationTypesEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssociationTypesEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssociationTypesEmbeddedItemsInnerAllOf:
        """Create an instance of AssociationTypesEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssociationTypesEmbeddedItemsInnerAllOf.parse_obj(obj)
