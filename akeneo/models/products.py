...
class Products(BaseModel):
    ...
    """
    embedded: Optional[ProductsEmbedded] = Field(None, alias="_embedded")
    ...
    def from_dict(cls, obj: dict) -> Products:
        ...
        _obj = Products.parse_obj({
            "embedded": ProductsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
