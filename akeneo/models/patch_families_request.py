...
class PatchFamiliesRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchFamiliesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchFamiliesRequest:
        """Create an instance of PatchFamiliesRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchFamiliesRequest.parse_obj(obj)

        _obj = PatchFamiliesRequest.parse_obj({
            "code": obj.get("code"),
