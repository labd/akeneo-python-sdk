...
class MediaFiles(BaseModel):
    ...
    """
    embedded: Optional[MediaFilesEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MediaFiles:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MediaFiles:
        """Create an instance of MediaFiles from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MediaFiles.parse_obj(obj)

        _obj = MediaFiles.parse_obj({
            "embedded": MediaFilesEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
