...
class ReferenceEntityRecordEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceEntityRecordEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceEntityRecordEmbeddedItemsInnerAllOf:
        """Create an instance of ReferenceEntityRecordEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ReferenceEntityRecordEmbeddedItemsInnerAllOf.parse_obj(obj)
        ...
        _obj = ReferenceEntityRecordEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
            "values": values,
