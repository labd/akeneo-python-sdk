...
class AssetEmbeddedItemsInnerAllOfValuesValueInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetEmbeddedItemsInnerAllOfValuesValueInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetEmbeddedItemsInnerAllOfValuesValueInner:
        """Create an instance of AssetEmbeddedItemsInnerAllOfValuesValueInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssetEmbeddedItemsInnerAllOfValuesValueInner.parse_obj(obj)

        _obj = AssetEmbeddedItemsInnerAllOfValuesValueInner.parse_obj({
