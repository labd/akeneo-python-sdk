...
class DeprecatedAsset(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeprecatedAsset:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeprecatedAsset:
        """Create an instance of DeprecatedAsset from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DeprecatedAsset.parse_obj(obj)

        _obj = DeprecatedAsset.parse_obj({
            "code": obj.get("code"),
