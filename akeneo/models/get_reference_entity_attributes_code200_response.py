...
class GetReferenceEntityAttributesCode200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetReferenceEntityAttributesCode200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetReferenceEntityAttributesCode200Response:
        """Create an instance of GetReferenceEntityAttributesCode200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetReferenceEntityAttributesCode200Response.parse_obj(obj)

        _obj = GetReferenceEntityAttributesCode200Response.parse_obj({
            "code": obj.get("code"),
