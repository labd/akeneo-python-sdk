...
class ProductModels(BaseModel):
    ...
    """
    embedded: Optional[ProductModelsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductModels:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductModels:
        """Create an instance of ProductModels from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductModels.parse_obj(obj)

        _obj = ProductModels.parse_obj({
            "embedded": ProductModelsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
