...
class ProductsEmbeddedItemsInnerAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    products: Optional[List[ProductsEmbeddedItemsInnerAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCodeProductsInner]] = Field(None, description="Array of objects containing product identifiers and quantities with which the product is in relation")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductsEmbeddedItemsInnerAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductsEmbeddedItemsInnerAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode:
        ...
        if type(obj) is not dict:
            return ProductsEmbeddedItemsInnerAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode.parse_obj(obj)

        _obj = ProductsEmbeddedItemsInnerAllOf1QuantifiedAssociationsQuantifiedAssociationTypeCode.parse_obj({
