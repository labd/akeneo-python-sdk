...
class ProductAssociations(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    association_type_code: Optional[Dict[str, ProductsEmbeddedItemsInnerAllOf1AssociationsAssociationTypeCode]] = Field(None, alias="associationTypeCode")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductAssociations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductAssociations:
        """Create an instance of ProductAssociations from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductAssociations.parse_obj(obj)

        _obj = ProductAssociations.parse_obj({
            "association_type_code": dict((_k, Dict[str, ProductsEmbeddedItemsInnerAllOf1AssociationsAssociationTypeCode].from_dict(_v)) for _k, _v in obj.get("associationTypeCode").items())
        })
        return _obj
