...
class AttributesEmbeddedItemsInnerAllOfLabels(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributesEmbeddedItemsInnerAllOfLabels:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributesEmbeddedItemsInnerAllOfLabels:
        """Create an instance of AttributesEmbeddedItemsInnerAllOfLabels from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributesEmbeddedItemsInnerAllOfLabels.parse_obj(obj)

        _obj = AttributesEmbeddedItemsInnerAllOfLabels.parse_obj({
