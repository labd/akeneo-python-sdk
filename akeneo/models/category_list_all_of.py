...
class CategoryListAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategoryListAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategoryListAllOf:
        """Create an instance of CategoryListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CategoryListAllOf.parse_obj(obj)

        _obj = CategoryListAllOf.parse_obj({
            "code": obj.get("code"),
