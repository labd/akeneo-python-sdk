...
class PAMAssetCategoriesEmbeddedItemsInner(BaseModel):
    ...
    __properties = ["_links", "code", "parent", "labels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PAMAssetCategoriesEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PAMAssetCategoriesEmbeddedItemsInner:
        """Create an instance of PAMAssetCategoriesEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PAMAssetCategoriesEmbeddedItemsInner.parse_obj(obj)

        _obj = PAMAssetCategoriesEmbeddedItemsInner.parse_obj({
