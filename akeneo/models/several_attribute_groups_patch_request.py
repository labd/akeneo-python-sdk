...
class SeveralAttributeGroupsPatchRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeveralAttributeGroupsPatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeveralAttributeGroupsPatchRequest:
        """Create an instance of SeveralAttributeGroupsPatchRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SeveralAttributeGroupsPatchRequest.parse_obj(obj)

        _obj = SeveralAttributeGroupsPatchRequest.parse_obj({
            "code": obj.get("code"),
