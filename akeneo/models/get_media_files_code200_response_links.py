...
class GetMediaFilesCode200ResponseLinks(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetMediaFilesCode200ResponseLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetMediaFilesCode200ResponseLinks:
        """Create an instance of GetMediaFilesCode200ResponseLinks from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetMediaFilesCode200ResponseLinks.parse_obj(obj)

        _obj = GetMediaFilesCode200ResponseLinks.parse_obj({
