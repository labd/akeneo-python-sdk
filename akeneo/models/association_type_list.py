...
class AssociationTypeList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssociationTypeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssociationTypeList:
        """Create an instance of AssociationTypeList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssociationTypeList.parse_obj(obj)

        _obj = AssociationTypeList.parse_obj({
