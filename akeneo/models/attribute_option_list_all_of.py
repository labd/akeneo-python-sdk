...
class AttributeOptionListAllOf(BaseModel):
    ...
    labels: Optional[AttributeOptionListAllOfLabels] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeOptionListAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeOptionListAllOf:
        """Create an instance of AttributeOptionListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeOptionListAllOf.parse_obj(obj)

        _obj = AttributeOptionListAllOf.parse_obj({
            "code": obj.get("code"),
            "attribute": obj.get("attribute"),
            "sort_order": obj.get("sort_order"),
            "labels": AttributeOptionListAllOfLabels.from_dict(obj.get("labels")) if obj.get("labels") is not None else None
        })
        return _obj
