...
class PublishedProductList(BaseModel):
    ...
    __properties = ["_links", "identifier", "enabled", "family", "categories", "groups", "values", "associations", "quantified_associations", "created", "updated"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublishedProductList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublishedProductList:
        """Create an instance of PublishedProductList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PublishedProductList.parse_obj(obj)

        _obj = PublishedProductList.parse_obj({
