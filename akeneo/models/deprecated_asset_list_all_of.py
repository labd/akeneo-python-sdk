...
class DeprecatedAssetListAllOf(BaseModel):
    ...
    variation_files: Optional[List[DeprecatedAssetListAllOfVariationFiles]] = Field(None, description="Variations of the PAM asset")
    reference_files: Optional[List[DeprecatedAssetListAllOfReferenceFiles]] = Field(None, description="Reference files of the PAM asset")
    __properties = ["code", "categories", "description", "localizable", "tags", "end_of_use", "variation_files", "reference_files"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeprecatedAssetListAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeprecatedAssetListAllOf:
        """Create an instance of DeprecatedAssetListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DeprecatedAssetListAllOf.parse_obj(obj)

        _obj = DeprecatedAssetListAllOf.parse_obj({
            "code": obj.get("code"),
            ...
            "variation_files": [DeprecatedAssetListAllOfVariationFiles.from_dict(_item) for _item in obj.get("variation_files")] if obj.get("variation_files") is not None else None,
            "reference_files": [DeprecatedAssetListAllOfReferenceFiles.from_dict(_item) for _item in obj.get("reference_files")] if obj.get("reference_files") is not None else None
        })
        return _obj
