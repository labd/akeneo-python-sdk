...
class AppCatalogList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppCatalogList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppCatalogList:
        """Create an instance of AppCatalogList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AppCatalogList.parse_obj(obj)

        _obj = AppCatalogList.parse_obj({
