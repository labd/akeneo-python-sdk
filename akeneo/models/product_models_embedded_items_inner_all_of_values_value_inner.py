...
class ProductModelsEmbeddedItemsInnerAllOfValuesValueInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductModelsEmbeddedItemsInnerAllOfValuesValueInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductModelsEmbeddedItemsInnerAllOfValuesValueInner:
        """Create an instance of ProductModelsEmbeddedItemsInnerAllOfValuesValueInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductModelsEmbeddedItemsInnerAllOfValuesValueInner.parse_obj(obj)

        _obj = ProductModelsEmbeddedItemsInnerAllOfValuesValueInner.parse_obj({
            "scope": obj.get("scope"),
