...
class AttributeOptionList(BaseModel):
    ...
    __properties = ["_links", "code", "attribute", "sort_order", "labels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeOptionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeOptionList:
        """Create an instance of AttributeOptionList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeOptionList.parse_obj(obj)

        _obj = AttributeOptionList.parse_obj({
