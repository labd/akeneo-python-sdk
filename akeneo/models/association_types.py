...
class AssociationTypes(BaseModel):
    ...
    """
    embedded: Optional[AssociationTypesEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssociationTypes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssociationTypes:
        """Create an instance of AssociationTypes from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssociationTypes.parse_obj(obj)

        _obj = AssociationTypes.parse_obj({
            "embedded": AssociationTypesEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
