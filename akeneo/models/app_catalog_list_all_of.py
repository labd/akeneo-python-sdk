...
class AppCatalogListAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppCatalogListAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppCatalogListAllOf:
        """Create an instance of AppCatalogListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AppCatalogListAllOf.parse_obj(obj)

        _obj = AppCatalogListAllOf.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
