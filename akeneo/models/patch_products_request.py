...
class PatchProductsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchProductsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchProductsRequest:
        """Create an instance of PatchProductsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchProductsRequest.parse_obj(obj)

        _obj = PatchProductsRequest.parse_obj({
            "uuid": obj.get("uuid"),
