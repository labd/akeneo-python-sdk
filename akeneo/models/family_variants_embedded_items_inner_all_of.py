...
class FamilyVariantsEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FamilyVariantsEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FamilyVariantsEmbeddedItemsInnerAllOf:
        """Create an instance of FamilyVariantsEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FamilyVariantsEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = FamilyVariantsEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
