...
class AttributeGroupsEmbeddedItemsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeGroupsEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeGroupsEmbeddedItemsInner:
        """Create an instance of AttributeGroupsEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeGroupsEmbeddedItemsInner.parse_obj(obj)

        _obj = AttributeGroupsEmbeddedItemsInner.parse_obj({
