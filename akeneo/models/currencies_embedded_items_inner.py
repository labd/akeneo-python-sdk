...
class CurrenciesEmbeddedItemsInner(BaseModel):
    ...
    __properties = ["_links", "code", "enabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrenciesEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrenciesEmbeddedItemsInner:
        """Create an instance of CurrenciesEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CurrenciesEmbeddedItemsInner.parse_obj(obj)

        _obj = CurrenciesEmbeddedItemsInner.parse_obj({
