...
class ProductsEmbeddedItemsInnerAllOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductsEmbeddedItemsInnerAllOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductsEmbeddedItemsInnerAllOf1:
        """Create an instance of ProductsEmbeddedItemsInnerAllOf1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductsEmbeddedItemsInnerAllOf1.parse_obj(obj)

        _obj = ProductsEmbeddedItemsInnerAllOf1.parse_obj({
            "uuid": obj.get("uuid"),
