...
class MeasureFamiliesEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeasureFamiliesEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeasureFamiliesEmbeddedItemsInnerAllOf:
        """Create an instance of MeasureFamiliesEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MeasureFamiliesEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = MeasureFamiliesEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
