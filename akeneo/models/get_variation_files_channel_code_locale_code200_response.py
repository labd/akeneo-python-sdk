...
class GetVariationFilesChannelCodeLocaleCode200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetVariationFilesChannelCodeLocaleCode200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetVariationFilesChannelCodeLocaleCode200Response:
        """Create an instance of GetVariationFilesChannelCodeLocaleCode200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetVariationFilesChannelCodeLocaleCode200Response.parse_obj(obj)

        _obj = GetVariationFilesChannelCodeLocaleCode200Response.parse_obj({
            "code": obj.get("code"),
