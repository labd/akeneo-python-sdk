...
class AssociationType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssociationType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssociationType:
        """Create an instance of AssociationType from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AssociationType.parse_obj(obj)

        _obj = AssociationType.parse_obj({
            "code": obj.get("code"),
