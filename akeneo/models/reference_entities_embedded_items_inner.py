...
class ReferenceEntitiesEmbeddedItemsInner(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    links: Optional[ReferenceEntitiesEmbeddedItemsInnerAllOfLinks] = Field(None, alias="_links")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceEntitiesEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceEntitiesEmbeddedItemsInner:
        """Create an instance of ReferenceEntitiesEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ReferenceEntitiesEmbeddedItemsInner.parse_obj(obj)

        _obj = ReferenceEntitiesEmbeddedItemsInner.parse_obj({
            "links": ReferenceEntitiesEmbeddedItemsInnerAllOfLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "code": obj.get("code"),
