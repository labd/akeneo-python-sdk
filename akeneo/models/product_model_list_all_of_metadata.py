...
class ProductModelListAllOfMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductModelListAllOfMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductModelListAllOfMetadata:
        """Create an instance of ProductModelListAllOfMetadata from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductModelListAllOfMetadata.parse_obj(obj)

        _obj = ProductModelListAllOfMetadata.parse_obj({
