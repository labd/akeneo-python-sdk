...
class ProductUuidListAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductUuidListAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductUuidListAllOf:
        """Create an instance of ProductUuidListAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductUuidListAllOf.parse_obj(obj)

        _obj = ProductUuidListAllOf.parse_obj({
            "uuid": obj.get("uuid"),
