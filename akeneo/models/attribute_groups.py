...
class AttributeGroups(BaseModel):
    ...
    """
    embedded: Optional[AttributeGroupsEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeGroups:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeGroups:
        """Create an instance of AttributeGroups from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeGroups.parse_obj(obj)

        _obj = AttributeGroups.parse_obj({
            "embedded": AttributeGroupsEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
