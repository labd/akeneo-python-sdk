...
class MediaFileAllOf1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MediaFileAllOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MediaFileAllOf1:
        """Create an instance of MediaFileAllOf1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MediaFileAllOf1.parse_obj(obj)

        _obj = MediaFileAllOf1.parse_obj({
            "code": obj.get("code"),
