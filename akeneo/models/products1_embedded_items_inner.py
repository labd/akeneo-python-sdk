...
class Products1EmbeddedItemsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Products1EmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Products1EmbeddedItemsInner:
        """Create an instance of Products1EmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Products1EmbeddedItemsInner.parse_obj(obj)

        _obj = Products1EmbeddedItemsInner.parse_obj({
