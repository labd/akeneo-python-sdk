...
class DeprecatedAssetList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeprecatedAssetList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeprecatedAssetList:
        """Create an instance of DeprecatedAssetList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DeprecatedAssetList.parse_obj(obj)

        _obj = DeprecatedAssetList.parse_obj({
