...
class ProductList(BaseModel):
    ...
    associations: Optional[ProductListAllOf1Associations] = None
    quantified_associations: Optional[ProductListAllOf1QuantifiedAssociations] = None
    ...
    __properties = ["_links", "uuid", "identifier", "enabled", "family", "categories", "groups", "parent", "values", "associations", "quantified_associations", "created", "updated", "metadata", "quality_scores", "completenesses"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductList:
        """Create an instance of ProductList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProductList.parse_obj(obj)

        _obj = ProductList.parse_obj({
            ...
            "associations": ProductListAllOf1Associations.from_dict(obj.get("associations")) if obj.get("associations") is not None else None,
            "quantified_associations": ProductListAllOf1QuantifiedAssociations.from_dict(obj.get("quantified_associations")) if obj.get("quantified_associations") is not None else None,
