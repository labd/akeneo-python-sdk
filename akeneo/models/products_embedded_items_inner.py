...
class ProductsEmbeddedItemsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductsEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductsEmbeddedItemsInner:
