...
class AttributeOptionsEmbeddedItemsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeOptionsEmbeddedItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeOptionsEmbeddedItemsInner:
        """Create an instance of AttributeOptionsEmbeddedItemsInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeOptionsEmbeddedItemsInner.parse_obj(obj)

        _obj = AttributeOptionsEmbeddedItemsInner.parse_obj({
