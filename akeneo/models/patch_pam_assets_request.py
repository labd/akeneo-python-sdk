...
class PatchPamAssetsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchPamAssetsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchPamAssetsRequest:
        """Create an instance of PatchPamAssetsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchPamAssetsRequest.parse_obj(obj)

        _obj = PatchPamAssetsRequest.parse_obj({
            "code": obj.get("code"),
