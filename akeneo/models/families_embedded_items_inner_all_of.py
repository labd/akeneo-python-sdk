...
class FamiliesEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FamiliesEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FamiliesEmbeddedItemsInnerAllOf:
        """Create an instance of FamiliesEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return FamiliesEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = FamiliesEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
