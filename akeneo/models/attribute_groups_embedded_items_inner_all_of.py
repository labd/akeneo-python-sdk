...
class AttributeGroupsEmbeddedItemsInnerAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeGroupsEmbeddedItemsInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeGroupsEmbeddedItemsInnerAllOf:
        """Create an instance of AttributeGroupsEmbeddedItemsInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeGroupsEmbeddedItemsInnerAllOf.parse_obj(obj)

        _obj = AttributeGroupsEmbeddedItemsInnerAllOf.parse_obj({
            "code": obj.get("code"),
