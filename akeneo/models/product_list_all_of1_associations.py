...
class ProductListAllOf1Associations(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductListAllOf1Associations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductListAllOf1Associations:
