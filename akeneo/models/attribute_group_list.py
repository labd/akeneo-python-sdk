...
class AttributeGroupList(BaseModel):
    ...
    __properties = ["_links", "code", "sort_order", "attributes", "labels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeGroupList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeGroupList:
        """Create an instance of AttributeGroupList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AttributeGroupList.parse_obj(obj)

        _obj = AttributeGroupList.parse_obj({
