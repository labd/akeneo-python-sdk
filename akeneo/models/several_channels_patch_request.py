...
class SeveralChannelsPatchRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeveralChannelsPatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeveralChannelsPatchRequest:
        """Create an instance of SeveralChannelsPatchRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SeveralChannelsPatchRequest.parse_obj(obj)

        _obj = SeveralChannelsPatchRequest.parse_obj({
            "code": obj.get("code"),
