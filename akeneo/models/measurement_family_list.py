...
class MeasurementFamilyList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeasurementFamilyList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeasurementFamilyList:
        """Create an instance of MeasurementFamilyList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MeasurementFamilyList.parse_obj(obj)

        _obj = MeasurementFamilyList.parse_obj({
            "code": obj.get("code"),
