...
class Currencies(BaseModel):
    ...
    """
    embedded: Optional[CurrenciesEmbedded] = Field(None, alias="_embedded")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Currencies:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Currencies:
        """Create an instance of Currencies from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Currencies.parse_obj(obj)

        _obj = Currencies.parse_obj({
            "embedded": CurrenciesEmbedded.from_dict(obj.get("_embedded")) if obj.get("_embedded") is not None else None,
