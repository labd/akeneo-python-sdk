...
class PatchProductModelsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchProductModelsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchProductModelsRequest:
        """Create an instance of PatchProductModelsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchProductModelsRequest.parse_obj(obj)

        _obj = PatchProductModelsRequest.parse_obj({
            "code": obj.get("code"),
