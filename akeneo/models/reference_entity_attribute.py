...
class ReferenceEntityAttribute(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceEntityAttribute:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceEntityAttribute:
        """Create an instance of ReferenceEntityAttribute from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ReferenceEntityAttribute.parse_obj(obj)

        _obj = ReferenceEntityAttribute.parse_obj({
            "code": obj.get("code"),
