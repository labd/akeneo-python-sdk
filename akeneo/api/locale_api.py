...
class LocaleApi(object):
    ...
    def get_locales(self, search : Annotated[Optional[StrictStr], Field(description="Filter locales, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None, page : Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None, limit : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, with_count : Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None, **kwargs) -> Locales:  # noqa: E501
        ...
        >>> thread = api.get_locales(search, page, limit, with_count, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_locales_with_http_info(search, page, limit, with_count, **kwargs)  # noqa: E501

    @validate_arguments
    def get_locales_with_http_info(self, search : Annotated[Optional[StrictStr], Field(description="Filter locales, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None, page : Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None, limit : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, with_count : Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None, **kwargs):  # noqa: E501
        """Get a list of locales  # noqa: E501
        ...
        >>> thread = api.get_locales_with_http_info(search, page, limit, with_count, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Locales, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def get_locales_code(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], **kwargs) -> LocalesEmbeddedItemsInnerAllOf:  # noqa: E501
        ...
        >>> thread = api.get_locales_code(code, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: LocalesEmbeddedItemsInnerAllOf
        """
        kwargs['_return_http_data_only'] = True
        return self.get_locales_code_with_http_info(code, **kwargs)  # noqa: E501

    @validate_arguments
    def get_locales_code_with_http_info(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], **kwargs):  # noqa: E501
        """Get a locale  # noqa: E501
        ...
        >>> thread = api.get_locales_code_with_http_info(code, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LocalesEmbeddedItemsInnerAllOf, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_locales_code" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "LocalesEmbeddedItemsInnerAllOf",
            '401': "GetProducts401Response",
            '403': "GetProducts401Response",
