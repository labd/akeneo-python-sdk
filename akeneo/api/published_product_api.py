...
class PublishedProductApi(object):
    ...
    @validate_arguments
    def get_published_products(self, search : Annotated[Optional[StrictStr], Field(description="Filter published products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None, scope : Annotated[Optional[StrictStr], Field(description="Filter published product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None, locales : Annotated[Optional[StrictStr], Field(description="Filter published product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None, attributes : Annotated[Optional[StrictStr], Field(description="Filter published product values to only return those concerning the given attributes, for more details see the <a href=\"/documentation/filter.html#filter-product-values\">Filter on product values</a> section")] = None, pagination_type : Annotated[Optional[StrictStr], Field(description="Pagination method type, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, page : Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None, search_after : Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, limit : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, with_count : Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None, **kwargs) -> PublishedProducts:  # noqa: E501
        ...
        >>> thread = api.get_published_products(search, scope, locales, attributes, pagination_type, page, search_after, limit, with_count, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: PublishedProducts
        """
        kwargs['_return_http_data_only'] = True
        return self.get_published_products_with_http_info(search, scope, locales, attributes, pagination_type, page, search_after, limit, with_count, **kwargs)  # noqa: E501

    @validate_arguments
    def get_published_products_with_http_info(self, search : Annotated[Optional[StrictStr], Field(description="Filter published products, for more details see the <a href=\"/documentation/filter.html\">Filters</a> section")] = None, scope : Annotated[Optional[StrictStr], Field(description="Filter published product values to return scopable attributes for the given channel as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None, locales : Annotated[Optional[StrictStr], Field(description="Filter published product values to return localizable attributes for the given locales as well as the non localizable/non scopable attributes, for more details see the <a href=\"/documentation/filter.html#filter-published-product-values\">Filter on published product values</a> section")] = None, attributes : Annotated[Optional[StrictStr], Field(description="Filter published product values to only return those concerning the given attributes, for more details see the <a href=\"/documentation/filter.html#filter-product-values\">Filter on product values</a> section")] = None, pagination_type : Annotated[Optional[StrictStr], Field(description="Pagination method type, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, page : Annotated[Optional[StrictInt], Field(description="Number of the page to retrieve when using the `page` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html#pagination\">Pagination</a> section")] = None, search_after : Annotated[Optional[StrictStr], Field(description="Cursor when using the `search_after` pagination method type. <strong>Should never be set manually</strong>, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, limit : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of results by page, see <a href=\"/documentation/pagination.html\">Pagination</a> section")] = None, with_count : Annotated[Optional[StrictBool], Field(description="Return the count of items in the response. Be carefull with that, on a big catalog, it can decrease performance in a significative way")] = None, **kwargs):  # noqa: E501
        """Get list of published products  # noqa: E501
        ...
        >>> thread = api.get_published_products_with_http_info(search, scope, locales, attributes, pagination_type, page, search_after, limit, with_count, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PublishedProducts, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_published_products" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_published_products_code(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], **kwargs) -> PublishedProductsEmbeddedItemsInnerAllOf:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PublishedProductsEmbeddedItemsInnerAllOf
        """
        kwargs['_return_http_data_only'] = True
        return self.get_published_products_code_with_http_info(code, **kwargs)  # noqa: E501

    @validate_arguments
    def get_published_products_code_with_http_info(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], **kwargs):  # noqa: E501
        """Get a published product  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PublishedProductsEmbeddedItemsInnerAllOf, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_published_products_code" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "PublishedProductsEmbeddedItemsInnerAllOf",
            '401': "GetProducts401Response",
            '403': "GetProducts401Response",
