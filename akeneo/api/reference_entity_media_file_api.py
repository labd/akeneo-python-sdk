...
class ReferenceEntityMediaFileApi(object):
    ...
    @validate_arguments
    def get_reference_entity_media_files_code(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def get_reference_entity_media_files_code_with_http_info(self, code : Annotated[StrictStr, Field(..., description="Code of the resource")], **kwargs):  # noqa: E501
        """Download the media file associated to a reference entity or a record  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_reference_entity_media_files_code" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def post_reference_entity_media_files(self, content_type : Annotated[StrictStr, Field(..., description="Equal to 'multipart/form-data', no other value allowed")], body : Optional[PostReferenceEntityMediaFilesRequest] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.post_reference_entity_media_files(content_type, body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_reference_entity_media_files_with_http_info(content_type, body, **kwargs)  # noqa: E501

    @validate_arguments
    def post_reference_entity_media_files_with_http_info(self, content_type : Annotated[StrictStr, Field(..., description="Equal to 'multipart/form-data', no other value allowed")], body : Optional[PostReferenceEntityMediaFilesRequest] = None, **kwargs):  # noqa: E501
        """Create a new media file for a reference entity or a record  # noqa: E501
        ...
        >>> thread = api.post_reference_entity_media_files_with_http_info(content_type, body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_reference_entity_media_files" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
